    ...
    <>
      <div className="paper">
        ...
        <div className="project-wrapper">
          {projectsTab.length && projectsTab.map(project => (
              ...
              <div className="background-wrapper">
                ...
                <div className="button-wrapper">
                  <div className={project.liveLink ? 'text' : 'text-solo'}>
                    <a target="blank" href={project.codeLink} className={project.liveLink ? 'view-code' : 'view-code solo'}>
                  ...
                  {project.liveLink && (
                    <div className="code">
                      <a target="blank" href={project.liveLink} className="live-demo">
